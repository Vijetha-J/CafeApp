...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position)
    {
        ...
        {
           // Toast.makeText(MessageAdapter.this,"WAIT",Toast.LENGTH_SHORT).show();
            if(fromUserID.equals(messageSenderId))
            {
        ...
        else if (fromMessageType.equals("docx") || fromMessageType.equals("pdf"))
        {
            if(fromUserID.equals(messageSenderId))
            {
                ...
                Picasso.get()
                        .load("https://firebasestorage.googleapis.com/v0/b/cafeapp-f1bef.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=27f70b17-6fd5-4208-9376-9825862d109c")
    ...
    private void deleteSendMessage(final int position,final MessageViewHolder holder)
    {
        ...
        rootRef.child("Messages")
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                ...
                {
                    Toast.makeText(holder.itemView.getContext(),"Deleted Susccessfully",Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    private void deleteReceiveMessage (final int position,final MessageViewHolder holder)
    {
        ...
        rootRef.child("Messages")
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                if (task.isSuccessful())
                {
                    Toast.makeText(holder.itemView.getContext(),"Deleteed Susccessfully",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(holder.itemView.getContext(),"Error Occurred",Toast.LENGTH_SHORT).show();
